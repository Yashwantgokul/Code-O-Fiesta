...
function calculateSeverity(durationMs: number): 'NORMAL' | 'MINOR' | 'SUSPICIOUS' | 'HIGH' | 'CRITICAL' {
...
function determineStatus(score: number): 'NORMAL' | 'REVIEW' | 'SUSPICIOUS' | 'HIGH_ALERT' {
